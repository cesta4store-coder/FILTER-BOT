...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cesta4store_db_user:<db_password>@cluster0.zsedgus.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
